...
export const productRepository = {
  ...
  async create(payload) {
    ...
    const result = await db.run(
      `INSERT INTO products (category_id, title, price, discount_price, rating_value, description, image_path, gallery_paths, is_new_arrival, is_best_seller, sold_count, stock_qty, set_persons, is_active, updated_at)
  ...
  async update(id, payload) {
    ...
    await db.run(
      `UPDATE products
       SET category_id = ?, title = ?, price = ?, discount_price = ?, rating_value = ?, description = ?, image_path = ?, gallery_paths = ?, is_new_arrival = ?, is_best_seller = ?, sold_count = ?, stock_qty = ?, set_persons = ?, is_active = ?, updated_at = CURRENT_TIMESTAMP
       WHERE id = ?`,
      [
        payload.category_id,
        payload.title,
